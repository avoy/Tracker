...
public class StoryDetails extends WOComponent {
	private static final long serialVersionUID = 1L;
    protected Item currentObject;
    protected String errorMessage;
    protected WOComponent theNextPage;
    protected String aRelease;
	protected NSArray potentialReleases;
    public String aMilestone;
	public Bugzilla story;
    protected String aString;	
	protected String projectLimitCharacter = "A";
    protected NSArray potentialProducts;
    protected String selectedProduct = "Device: Secure Storage";
    protected NSArray potentialAssignees;
    protected String assigneeSelectString;
	protected NSMutableArray tasks;
	
	public StoryDetails(WOContext context) {
        super(context);
		story = new Bugzilla();
